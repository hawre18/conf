...
class ProductController extends Controller
{
    ...
    public function varie($id){
        $product=Product::findorfail($id);
        return view('Admin.varietes.create',compact(['product']));
    }
    public function features($id){
        $product=Product::findorfail($id);
        return view('Admin.features.create',compact(['product']));
    }
    public function baners($id){
        $product=Product::findorfail($id);
        return view('Admin.baners.create',compact(['product']));
    }
}
