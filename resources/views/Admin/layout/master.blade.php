            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('varietes.index')}}"><i class="fa fa-circle-o"></i>لیست تنوع ها</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('features.index')}}"><i class="fa fa-circle-o"></i>لیست فیچرها</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('baners.index')}}"><i class="fa fa-circle-o"></i>لیست بنرها</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
