    ...
    <section id="app" class="content" style="direction: rtl">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title pull-right">ایجاد امکانات محصول {{$product->title}}</h3>
                </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <form method="post" action="\baners">
                            @csrf
                            <div class="form-group">
                                <label for="title">عنوان بنر</label>
                                <input type="text" name="title" class="form-control" value="{{old('title')}}" placeholder="عنوان بنر">
