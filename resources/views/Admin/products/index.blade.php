                            ...
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-warning" href="{{route('products.varietes',$product->id)}}">افزودن تنوع</a>
                                        <a class="btn btn-warning" href="{{route('products.features',$product->id)}}">افزودن امکانات</a>
                                        <a class="btn btn-warning" href="{{route('products.baners',$product->id)}}">افزودن بنر</a>
